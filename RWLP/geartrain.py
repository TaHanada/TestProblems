...
for x1_ind in range(12, 61):
    for x2_ind in range(12, 61):
        for x3_ind in range(12, 61):
            for x4_ind in range(12, 61):
                x1 = x1_ind
                x2 = x2_ind
                x3 = x3_ind
                x4 = x4_ind
...
analy_x1 = np.reshape(analy_x1, (49, 4))
...
analy_x2 = np.reshape(analy_x2, (49, 4))
...
analy_x3 = np.reshape(analy_x3, (49, 4))
...
analy_x4 = np.reshape(analy_x4, (49, 4))
